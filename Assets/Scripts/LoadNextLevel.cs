...
public class LoadNextLevel : MonoBehaviour
{
    ...
    IEnumerator LoadYourAsyncScene()
    {
        ...
        AsyncOperation asyncLoad = SceneManager.LoadSceneAsync(MiniGame1, LoadSceneMode.Additive);
        ...
        SceneManager.MoveGameObjectToScene(Player, SceneManager.GetSceneByName(MiniGame1));
